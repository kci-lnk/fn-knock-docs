...
> **推荐使用官网原生 FPK**
>
> 官网提供的飞牛原生应用 FPK 是 fn-knock 功能最完整的版本，支持当前全部功能。如果此前从飞牛应用中心（应用商店）安装了 fn-knock，请注意该应用实际是 Docker 版本，并非原生 FPK。建议先备份现有配置和数据，卸载应用中心版本，再根据设备架构从上方官网下载并手动安装原生 FPK；不要同时运行两个版本，以免发生端口冲突。
